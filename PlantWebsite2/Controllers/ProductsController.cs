...
namespace PlantWebsite.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,LatinName,Description,Kind,Type,Water,Light,ProductDate,Trade")] Product product, IFormFile Picture)
        {
            ...
            //This clause is supposed to check if the only error is an empty image, since I (Mattias) can't find a way to get rid of it. Any other error should still trigger the clause.
